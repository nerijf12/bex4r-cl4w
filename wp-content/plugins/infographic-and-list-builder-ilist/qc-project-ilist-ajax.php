...
function ilist_upvote_ajax_action_stuff()
{
	...
	//Get posted items
	$action = sanitize_text_field(trim($_POST['action']));
	$post_id = sanitize_text_field(trim($_POST['post_id']));
	$meta_title = sanitize_text_field(trim($_POST['meta_title']));
	$meta_link = sanitize_text_field(trim($_POST['meta_link']));
	$meta_desc = sanitize_text_field(trim($_POST['meta_desc']));
	$li_id = sanitize_text_field(trim($_POST['li_id']));
...
if($list_type=='textlist'){
	...
	$templatearray['elegant'] = array(
		...
		'premium-style-17'   => esc_html__( 'Premium Style 17', 'cmb2' ),
		'premium-style-18'   => esc_html__( 'Premium Style 18', 'cmb2' ),
		'premium-style-19'   => esc_html__( 'Premium Style 19', 'cmb2' ),
		'premium-style-20'   => esc_html__( 'Premium Style 20', 'cmb2' ),
		'premium-style-21'   => esc_html__( 'Premium Style 21', 'cmb2' ),
		'premium-style-22'   => esc_html__( 'Premium Style 22', 'cmb2' ),
		'premium-style-23'   => esc_html__( 'Premium Style 23', 'cmb2' ),
		'premium-style-25'   => esc_html__( 'Premium Style 25', 'cmb2' ),
		'premium-style-26'   => esc_html__( 'Premium Style 26', 'cmb2' ),
		'premium-style-27'   => esc_html__( 'Premium Style 27', 'cmb2' ),
		'premium-style-28'   => esc_html__( 'Premium Style 28', 'cmb2' ),
		'premium-style-29'   => esc_html__( 'Premium Style 29', 'cmb2' ),
		'premium-style-30'   => esc_html__( 'Premium Style 30', 'cmb2' ),
		'premium-style-31'   => esc_html__( 'Premium Style 31', 'cmb2' ),
		'premium-style-32'   => esc_html__( 'Premium Style 32', 'cmb2' ),
		'premium-style-33'   => esc_html__( 'Premium Style 33', 'cmb2' ),
		'premium-style-34'   => esc_html__( 'Premium Style 34', 'cmb2' ),
		'premium-style-35'   => esc_html__( 'Premium Style 35', 'cmb2' ),
		'premium-style-36'   => esc_html__( 'Premium Style 36', 'cmb2' ),
		'premium-style-37'   => esc_html__( 'Premium Style 37', 'cmb2' ),
		'premium-style-38'   => esc_html__( 'Premium Style 38', 'cmb2' ),
		'premium-style-39'   => esc_html__( 'Premium Style 39', 'cmb2' ),
	);
...
?>
	<div id="ilist-modal" class="ilistmodaltemplate">
		...
		<div class="modal-content-template" data="<?php echo $list_type; ?>">
			...
			<h3><?php _e( 'Free Templates' , 'iList' ); ?></h3>
			<hr/>
